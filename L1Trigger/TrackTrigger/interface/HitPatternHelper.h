...
//  i)Looping over sensor modules and make predictions based on spactial coordinates of tracks. This prediction is considerd more accurate.
...
namespace HPH {
    ...
    class HitPatternHelper{
       ...
       public:
        ...
        int getnumMissingInterior1(){return numMissingInterior1_;}//The number of missing interior layers (using only hitpattern)
        int getnumMissingInterior2(){return numMissingInterior2_;}//The number of missing interior layers (using hitpattern and sensor modules)
        ...
        int ReducedId(int layerId); //Converts layer id (1~6->L1~L6;11~15->D1~D5) to reduced layer id (0~5->L1~L6;6~10->D1~D5)
