...
ChannelAssignment_params = cms.PSet (
  ...
  SeedTypes = cms.vstring( "L1L2", "L2L3", "L3L4", "L5L6", "D1D2", "D3D4", "L1D1", "L2D1" ), # seed types used in reduced tracklet algorithm (position gives int value)

  SeedTypesSeedLayers = cms.PSet (      # seeding layers of seed types in reduced config using default layer id [barrel: 1-6, discs: 11-15]
    L1L2 = cms.vint32(  1,  2 ),
    L2L3 = cms.vint32(  2,  3 ),
    L3L4 = cms.vint32(  3,  4 ),
    L5L6 = cms.vint32(  5,  6 ),
  ...
  SeedTypesProjectionLayers = cms.PSet ( # layers a seed types can project to in reduced config using default layer id [barrel: 1-6, discs: 11-15]
