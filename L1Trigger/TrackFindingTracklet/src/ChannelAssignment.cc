...
namespace trklet {
  ...
  ChannelAssignment::ChannelAssignment(const Config& iConfig, const Setup* setup)
      : setup_(setup),
        ...
        tqWidthBDTchi20_(iConfig.tqWidthBDTchi20_),
        tqWidthBDTchi21_(iConfig.tqWidthBDTchi21_),
        tqBaseShiftBDTchi20_(iConfig.tqBaseShiftBDTchi20_),
        tqBaseShiftBDTchi21_(iConfig.tqBaseShiftBDTchi21_),
