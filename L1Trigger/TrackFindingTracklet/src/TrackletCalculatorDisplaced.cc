...
bool TrackletCalculatorDisplaced::LLLSeeding(const Stub* innerFPGAStub,
  ...
  exacttracklet(r1,
                ...
                phiderdisk,
                rderdisk);
edm::LogVerbatim("Tracklet")<<__LINE__<<":"<<__FILE__<<"LLL Exact values "<<innerFPGAStub->isBarrel()<<middleFPGAStub->isBarrel()<<outerFPGAStub->isBarrel()<<" "<<phi1<<", "<<z1<<", "<<r1<<", "<<phi2<<", "<<z2<<", "<<r2<<", "<<phi3<<", "<<z3<<", "<<r3<<endl;
  ...
  edm::LogVerbatim("Tracklet")<<__LINE__<<":"<<__FILE__<<"LLL Approx values "<<innerFPGAStub->isBarrel()<<middleFPGAStub->isBarrel()<<outerFPGAStub->isBarrel()<<" "<<phi1<<", "<<z1<<", "<<r1<<", "<<phi2<<", "<<z2<<", "<<r2<<", "<<phi3<<", "<<z3<<", "<<r3<<endl;
  ...
  for (unsigned int i=0; i < toR_.size(); ++i) {
    edm::LogVerbatim("Tracklet")<<"phiprojapprox["<<i<<"]: "<<phiprojapprox[i]<<" phiproj["<<i<<"]: "<<phiproj[i]<<endl;
    edm::LogVerbatim("Tracklet")<<"zprojapprox["<<i<<"]: "<<zprojapprox[i]<<" zproj["<<i<<"]: "<<zproj[i]<<endl;
    edm::LogVerbatim("Tracklet")<<"phiderapprox["<<i<<"]: "<<phiderapprox[i]<<" phider["<<i<<"]: "<<phider[i]<<endl;
    edm::LogVerbatim("Tracklet")<<"zderapprox["<<i<<"]: "<<zderapprox[i]<<" zder["<<i<<"]: "<<zder[i]<<endl;
  }

  for (unsigned int i=0; i < toZ_.size(); ++i) {
    edm::LogVerbatim("Tracklet")<<"phiprojdiskapprox["<<i<<"]: "<<phiprojdiskapprox[i]<<" phiprojdisk["<<i<<"]: "<<phiprojdisk[i]<<endl;
    edm::LogVerbatim("Tracklet")<<"rprojdiskapprox["<<i<<"]: "<<rprojdiskapprox[i]<<" rprojdisk["<<i<<"]: "<<rprojdisk[i]<<endl;
    edm::LogVerbatim("Tracklet")<<"phiderdiskapprox["<<i<<"]: "<<phiderdiskapprox[i]<<" phiderdisk["<<i<<"]: "<<phiderdisk[i]<<endl;
    edm::LogVerbatim("Tracklet")<<"rderdiskapprox["<<i<<"]: "<<rderdiskapprox[i]<<" rderdisk["<<i<<"]: "<<rderdisk[i]<<endl;
  }
...
bool TrackletCalculatorDisplaced::DDLSeeding(const Stub* innerFPGAStub,
  ...
  edm::LogVerbatim("Tracklet")<<__LINE__<<":"<<__FILE__<<" DLL Exact values "<<innerFPGAStub->isBarrel()<<middleFPGAStub->isBarrel()<<outerFPGAStub->isBarrel()<<" "<<phi1<<", "<<z1<<", "<<r1<<", "<<phi2<<", "<<z2<<", "<<r2<<", "<<phi3<<", "<<z3<<", "<<r3<<endl;
  ...
  edm::LogVerbatim("Tracklet")<<__LINE__<<":"<<__FILE__<<"DLL Approx values "<<innerFPGAStub->isBarrel()<<middleFPGAStub->isBarrel()<<outerFPGAStub->isBarrel()<<" "<<phi1<<", "<<z1<<", "<<r1<<", "<<phi2<<", "<<z2<<", "<<r2<<", "<<phi3<<", "<<z3<<", "<<r3<<endl;
...
bool TrackletCalculatorDisplaced::LLDSeeding(const Stub* innerFPGAStub,
  ...
  edm::LogVerbatim("Tracklet")<<__LINE__<<":"<<__FILE__<<"LLD Exact values "<<innerFPGAStub->isBarrel()<<middleFPGAStub->isBarrel()<<outerFPGAStub->isBarrel()<<" "<<phi3<<", "<<z3<<", "<<r3<<", "<<phi1<<", "<<z1<<", "<<r1<<", "<<phi2<<", "<<z2<<", "<<r2<<endl;
  ...
  edm::LogVerbatim("Tracklet")<<__LINE__<<":"<<__FILE__<<"LLD approx values "<<innerFPGAStub->isBarrel()<<middleFPGAStub->isBarrel()<<outerFPGAStub->isBarrel()<<" "<<phi3<<", "<<z3<<", "<<r3<<", "<<phi1<<", "<<z1<<", "<<r1<<", "<<phi2<<", "<<z2<<", "<<r2<<endl;
                ...
                double &zproj, double &zprojder)
{
  ...
  if(true) edm::LogVerbatim("Tracklet")<< "approx proj layer at "<<rmean<<" : "<< phiproj <<" "<<zproj<<endl;
}
                    ...
                    double &rproj, double &rprojder)
{
  ...
  if(true) edm::LogVerbatim("Tracklet")<< "approx proj disk at"<<zmean<<" : "<< phiproj <<" "<<rproj<<endl;
}
